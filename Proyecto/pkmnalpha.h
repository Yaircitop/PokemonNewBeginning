...
void battle(Player *user1,Player *user2){
    ...
    while(true){
        ...
        flag = 1;
        while(flag){
            printf("chose 0 to chose a moveset, 1 to see your team, 2 to see your bag, and 3 to flee. '4'to exit\n");
        ...
        flag = 1;
        while(flag){
            printf("chose 0 to chose a moveset, 1 to see your team, 2 to see your bag, and 3 to flee\n");
